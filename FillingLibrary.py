...
publisherArt.add_book('2006','Art','Decorate your house','Stephane Plaza','French','2017')
...
publisherScience.add_book('3003','Science','Apple Gravity','Isaac Newton','English','1703')
...
publisherScience.add_book('3006','Science','Climate Change','Greta Thunberg','English','2015')
publisherScience.add_book('3007','Science','Dealing with nuclear waste','Sebastien Quinn','English','2023')
publisherScience.add_book('3008','Science','Finance model and equation','Christopher Tks','Chinese','2020')
publisherScience.add_book('3009','Science','Modelization in aeronautics','Louis-Hadrien Gros','English','2019')

###Publish Novel Books
publisherNovel.add_book('4001','Novel','Immortal','Chuck Norris','English','1980')
publisherNovel.add_book('4002','Novel','Canice Glowen','Edmond Fauret','French','1869')
